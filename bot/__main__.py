...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Owner", "https://t.me/KodokZumaIjo")
    buttons.buildbutton("Bowkep", "https://www.xnxx.com")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Hello bocah2 kontol:) 
Saya adalah bot yang membagongkan ya:) nonton bowkep dulu aja:)'''
